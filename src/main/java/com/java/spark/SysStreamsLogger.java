...
/**
 * <b>Reference:</b> https://stackoverflow.com/questions/11187461/redirect-system-out-and-system-err-to-slf4j
 * <br>
 * <br>
 * <b>Description:</b> Paired down class based on the above reference.  This class
 * redirects system.out (console) output to the log file defined in the logback.xml file used to to submit the job. Entries in the log file that capture console output
 * from transformations or RDDs will have the logger of SysStreamsLogger.java as shown in the example below. 
 * <br>
 * <br>
 * <b>Ex.</b> INFO 2018-10-04 19:57:45,106 SysStreamsLogger.java:163
 *
 */
...
public class SysStreamsLogger {
	...
	public static void bindSystemStreams() {
		// Enable autoflush
		System.setOut(new PrintStream(new LoggingOutputStream(sysOutLogger), true));
